        ...
        <form onSubmit={onSubmitHandle} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll '>
                ...
                <div>
                    ...
                    <textarea onChange={(e)=>setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded '  placeholder='write about yourself' rows={5} ></textarea>
                </div>
                <button type='submit' className='bg-primary text-white mt-4 px-10 py-4 rounded-full'>Add doctor</button>
            </div>
        </form>
    )
}
